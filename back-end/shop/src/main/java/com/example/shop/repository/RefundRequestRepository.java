...
public interface RefundRequestRepository extends JpaRepository<RefundRequest, Integer> {
  ...
  @Query(value = """
        ...
        where status = 'PENDING' and createdAt between :startAt and :endAt
      """, nativeQuery = true)
  public Long TotalUnhandledRefundRequests(@Param(value = "startAt") LocalDateTime startAt, @Param(value = "endAt") LocalDateTime endAt);
}
